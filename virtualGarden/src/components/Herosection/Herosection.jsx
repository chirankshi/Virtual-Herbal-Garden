...
import gardenGif from "../../assets/images/gardengif.gif";
  ...
  return (
    <section className="hero-section" id="home">
      ...
      <div className="hero-content">
        ...
        {/* <Link to='/chatbot'className="hero-btn"><button className="button">chat us</button></Link>       */}
  <Link to="/explore-tour" className="hero-btn">
